module timeInt
  ...
  contains
    ...
    subroutine initialCondition( N, dN_dxi, dN_deta, S_m, S_n, S_trans, S_nrhs, S_ipiv, S_ldb, delta_t, Uinit) 
      ...
      double precision, allocatable, dimension(:,:) :: A_C0, A_U0
      ...
      integer                                       :: ielem, igaus, ibase, S_info
      ...
      do ielem = 1, nelem 
        ...
        do ibase = 1, nne
          xcoor = element_nodes(ibase,1)
          !print*, 'xcoor',ibase, ' ', xcoor
          cc    = (  xcoor - x0 )
          ux_cond(ibase) = aa* exp( -(cc/bb)**2 )
        end do
    ...
    subroutine TimeIntegration(N, dN_dxi, dN_deta, Hesxieta, time_ini, time_fin, max_time,&
      ...
      call initialCondition( N, dN_dxi, dN_deta, S_m, S_n, S_trans, S_nrhs, S_ipiv, S_ldSol, delta_t, Uinit) 
